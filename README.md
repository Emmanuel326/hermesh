...
Hermesh rethinks this entirely.
...
Demo (What to Show Judges)

1. Start Node A
2. Start Node B → instantly appears
3. Kill Node B → transitions to dead
4. Open HashScan → show immutable history
5. Restart node → full state rebuild from log
